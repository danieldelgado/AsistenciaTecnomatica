...
public class jDispositivos {
    ...
    public static Player reproductor(MediaLocator ml)
    {
        ...
        try {
            p = Manager.createRealizedPlayer(ml);
             ...
             mensajero.mensajeError(null, "No se pudo cargar el Player");
        }catch (IOException ex) {
            mensajero.mensajeError(null, "Error de Entrada/Salida");
        } catch (NoPlayerException ex) {
            mensajero.mensajeError(null, "No player Exception!");
        }
        return p;
    }
    /*
     ...
     */
    public static void menuDispositivos(Camara padre,JMenu dispositivos)
    {
